...
<p>Currently v5.3.2.0</p>
        ...
        <div className="d-flex flex-column">
          ...
          <div className="d-flex justify-content-between mt-3">
            ...
            <a href="https://x.com/?lang=en&mx=2" style={{textDecoration:'none',color:'white'}}target='_blank'><i className="fa-brands fa-github"></i></a>
            <a href="https://x.com/?lang=en&mx=2" style={{textDecoration:'none',color:'white'}}target='_blank'><i className="fa-brands fa-tiktok"></i></a>
          </div>
        </div>
      </div>
